        ...
        else
        {
            ...
            if ((p_75144_3_ == 0 || p_75144_3_ == 1) && (p_75144_2_ == 0 || p_75144_2_ == 1))
            {
                ...
                else if (p_75144_3_ == 1)
                {
                    ...
                    {
                        itemstack3 = this.transferStackInSlot(player, p_75144_1_);
                        ...
                        if (itemstack3 != null)
                        {
                            ...
                            {
                                this.retrySlotClick(p_75144_1_, p_75144_2_, true, player);
                            }
                        }
                    }
                }
            ...
            else if (p_75144_3_ == 3 && player.capabilities.isCreativeMode && inventoryplayer.getItemStack() == null && p_75144_1_ >= 0)
            {
                slot2 = (Slot)this.inventorySlots.get(p_75144_1_);
